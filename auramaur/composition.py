...
async def assemble_components(
    *, settings, db_path: str, hybrid: bool, exchange_filter: str | None,
    ...
    # Primary official information lanes. These sources begin in shadow mode:
    # their observations are persisted but withheld from forecasts until their
    # information-strategy cells earn influence through paired trials.
    ...
    # Pre-register the first shadow experiments. Registration is metadata-only;
    # influence remains zero until paired, resolved trials clear every gate.
