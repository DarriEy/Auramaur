...
class CrossVenueArbPillar:
    ...
    async def _enter_pair(self, a: Market, b: Market, edge: float,
        ...
        # replaced was dead (no-op since eed51b8). The booked_as_position
        # gate matches the single-leg path above: a resting leg gets no
        # signals row, but traded_at still lands, retiring the pair.
